...
def run_stage(stage, exp_dir, bpp, latent, ngpu, data_dir, dinov2_path, prev_dir=None):
    ...
    # Load and resolve template config (handles load: includes)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="CoD-Lite multi-stage training")
    parser.add_argument("--data_dir", type=str, required=True,
                        help="Dataset root containing anno_256/, anno_512/, test/")
    ...
    print(f"CoD-Lite Training: {args.exp_name}  bpp={args.bpp}  latent={args.latent}  gpus={ngpu}")
